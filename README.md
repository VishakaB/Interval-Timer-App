...
- Create a progressive web app, PWA (website that uses modern web features to behave like a native app), using HTML for frontend, Javascript for backend, and deploy it as a webapp using Vercel, so that it is accessible to anyone.
...
The app is deployed using Vercel. Vercel imports the code from Github, and deploys the app in the web by exposing the app via a publicly accessible URL. 

URL: https://interval-timer-app-git-main-vishakabs-projects.vercel.app/
